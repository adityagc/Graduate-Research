...
summ <- summary(Y_fit)
errors <- summ$cve
write.csv(errors, file = "~/Desktop/MS-Research/Experiments/LowBirthWeight/large-lbw/R/log-transform-errors.csv")
weights <- Y_fit$fit$beta
write.csv(weights, file = "~/Desktop/MS-Research/Experiments/LowBirthWeight/large-lbw/R/log-transform-weights.csv")
out <- rbind(weights, errors)
write.csv(out, file = "~/Desktop/MS-Research/Experiments/LowBirthWeight/large-lbw/R/log-tranform-out.csv")
out